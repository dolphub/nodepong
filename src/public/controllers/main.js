...
/* global angular */
{
    const app = angular.module('nodePong');
    ...
    app.controller('pongCtrl', ['$scope', 'socket', '$log', '$interval', '$window', 'Ball', ($scope, socket, $log, $interval, $window, Ball) => {
        $scope.court = {};
        $scope.court.ID = -1;
